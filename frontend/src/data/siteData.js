...
export const testimonials = [
    // Celebrity Testimonials
    {
        ...
        name: 'John Abraham',
        role: 'Actor & Producer',
        content: '"Dr Pai is a kind, knowledgeable and endearing person who, with her team at SkinLab, has made sure that I have no more acne today. She is the best."',
        image: 'https://skinlab.in/wp-content/uploads/2025/03/John-Abraham.webp',
        isCelebrity: true,
    },
    {
        id: 2,
        name: 'Juhi Chawla',
        role: 'Actor & Social Activist',
        content: '"Dr. Pai always makes me feel special, gives me her best advice and a hug! Every job is a portrait of the person who has done it and Dr Pai autographs hers with excellence."',
        image: 'https://skinlab.in/wp-content/uploads/2025/10/JUHI-CHAWLA.webp',
        isCelebrity: true,
    },
    {
        id: 3,
        name: 'Gauri Khan',
        role: 'Film Producer',
        content: '"I discovered Dr. Pai\'s magical facials over ten years ago and since then I visit SkinLab for that extra dose of care and pampering that my skin needs. The entire SkinLab team also embodies the same values that she so strongly stands for: warmth, a steadfast work ethic and incomparable expertise."',
        image: 'https://skinlab.in/wp-content/uploads/2025/03/image-1.png',
        isCelebrity: true,
    },
    {
        id: 4,
        name: 'Vikram Phadnis',
        role: 'Fashion Designer & Film Director',
        content: '"What amazes me is the consistency in quality and care that every single doctor at SkinLab provides. I\'m glad that someone like Dr. Pai took the initiative to understand the need for cosmetic clinics here in India."',
        image: 'https://skinlab.in/wp-content/uploads/2025/03/vik.webp',
        isCelebrity: true,
    },
    {
        id: 5,
        name: 'Mandira Bedi',
        role: 'Actor, Anchor & Designer',
        content: '"Dr. Pai has advised me on everything, from the smallest breakout to even the kind of make-up I should use. Month after month, since I first met Jamuna, I have been going for the most amazing facials and clean-ups to her clinic SkinLab."',
        image: 'https://skinlab.in/wp-content/uploads/2025/03/Mandira-Bedi.jpg',
        isCelebrity: true,
    },
    {
        id: 6,
        name: 'Pooja Chopra',
        role: 'Miss India 2009',
        content: '"I can\'t thank Miss India enough for bringing this skin fairy into my life. My skin and I both feel the safest and happiest in Dr Pai\'s hands."',
        image: 'https://skinlab.in/wp-content/uploads/2025/03/pooja-choopara.webp',
        isCelebrity: true,
    },
    // Regular Patient Testimonials
    {
        id: 7,
        name: 'Priya Sharma',
        role: 'Patient',
